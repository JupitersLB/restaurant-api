...
puts "Creating items and menu items"
...
item.photo.attach(io: file, filename: "caesar.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
...
params[:price] = 1200
item = Item.new(params)
item.photo.attach(io: file, filename: "nicoise.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created item #{item.name}"

file = URI.open('https://cafedelites.com/wp-content/uploads/2018/03/Sheet-Pan-Salmon-1.jpg')
params = {}
...
params[:price] = 1800
item = Item.new(params)
item.photo.attach(io: file, filename: "salmon.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created item #{item.name}"
...
params[:price] = 2100
item = Item.new(params)
item.photo.attach(io: file, filename: "sea-bass.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created menu item #{item.name}"
...
params[:price] = 2200
item = Item.new(params)
item.photo.attach(io: file, filename: "gammon.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created item #{item.name}"
...
params[:price] = 2400
item = Item.new(params)
item.photo.attach(io: file, filename: "pie.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created menu item #{item.name}"
...
params[:price] = 700
item = Item.new(params)
item.photo.attach(io: file, filename: "sapporo.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created menu item #{item.name}"
...
params[:price] = 450
item = Item.new(params)
item.photo.attach(io: file, filename: "oolong.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created menu item #{item.name}"
...
params[:price] = 1100
item = Item.new(params)
item.photo.attach(io: file, filename: "cheesecake.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created menu item #{item.name}"
...
params[:price] = 1300
item = Item.new(params)
item.photo.attach(io: file, filename: "fudge.jpg", content_type: 'image/jpg')
item.save
MenuItem.create(item: item, menu: menu)
puts "Created menu item #{item.name}"
